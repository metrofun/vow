...
Resolver.prototype = {
    ...
    addCallbacks : function(resolver, onFulfilled, onRejected, onProgress, ctx) {
        ...
        this.isResolved() || this._progressCallbacks.push({ resolver : resolver, fn : onProgress, ctx : ctx });
    },
...
var Promise = function(resolverFnOrVal) {
    this._resolver = new Resolver();

    if(arguments.length) {
        isFunction(resolverFnOrVal)?
            resolverFnOrVal(this._resolver) :
            this._resolver.fulfill(resolverFnOrVal);
    }
};
...
Promise.prototype = {
    ...
    then : function(onFulfilled, onRejected, onProgress, ctx) {
        var resolver,
            promise = new Promise(function(_resolver) {
                resolver = _resolver;
            });
    ...
    timeout : function(timeout) {
        var resolver,
            ...
            timer = setTimeout(
                function() {
                    resolver.reject(Error('timed out'));
                },
                timeout);
...
var Vow = {
    promise : function(promiseOrResolverFn) {
        return arguments.length?
            Vow.isPromise(promiseOrResolverFn)?
                promiseOrResolverFn :
                new Promise(promiseOrResolverFn) :
            new Promise();
    },
    ...
    all : function(promises) {
        var resolver,
            resPromise = new Promise(function(_resolver) {
                resolver = _resolver;
            }),
